    ...
    <div class="card-header">
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Laundry Service</h5>
            </div>
            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                ...
                <div id="dashboard-actions">
                    <a href="<?= base_url() ?>service/create" class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1">New</span></a>
            ...
            <table class="table table-sm table-dashboard fs--1 data-table border-bottom" data-options='{"responsive":false,"pagingType":"simple","lengthChange":false,"searching":false,"pageLength":8,"columnDefs":[{"targets":[0,6],"orderable":false}],"language":{"info":"_START_ to _END_ Items of _TOTAL_ — <a href=\"#!\" class=\"font-weight-semi-bold\"> view all <span class=\"fas fa-angle-right\" data-fa-transform=\"down-1\"></span> </a>"},"buttons":["copy","excel"]}'>
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pr-1 align-middle">Service Name</th>
                        <th class="sort pr-1 align-middle">Rate</th>
                ...
                <tbody id="purchases">
                    ...
                    ?>
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="align-middle"><?= $d->price ?>BDT</td>
                                    ...
                                    <td class="align-middle white-space-nowrap">
                                        <div class="dropdown text-sans-serif">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="dropdown0">
                                                <div class="bg-white py-2"><a class="dropdown-item" href="#!">View</a><a class="dropdown-item" href="<?= base_url("service/update/$d->id") ?>">Edit</a><a class="dropdown-item" href="#!">Refund</a>
                                                    <div class="dropdown-divider"></div><a class="dropdown-item text-warning" href="#!">Archive</a><a class="dropdown-item text-danger" href="<?= base_url("service/delete/$d->id") ?>">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
