...
<html lang="en-US" dir="ltr">
  ...
  <body>
          ...
          <nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand">
                  ...
                  <div class="dropdown-menu">
                    <div class="scrollbar perfect-scrollbar py-3" style="height: 24rem;">
                      ...
                      <a class="dropdown-item px-card py-2" href="#!">
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail mr-2"><img class="border h-100 w-100 fit-cover rounded-lg')?>" src="<?= base_url('assets/img/products/3-thumb.png')?>" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <a class="dropdown-item px-card py-2" href="#!">
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail mr-2"><img class="img-fluid" src="<?= base_url('assets/img/icons/zip.png')?>" alt="" /></div>
                          <div class="flex-1">
            ...
            <ul class="navbar-nav navbar-nav-icons ml-auto flex-row align-items-center">
              <li class="nav-item d-none d-md-block">
                <a class="nav-link px-3 py-0" href="https://prium.github.io/falcon/v3.0.0-beta6/" target="_blank"><img src="<?= base_url('assets/img/logos/bootstrap-5.png')?>" alt="" height="35" /></a>
              </li>
              <li class="nav-item">
    ...
    <script src="<?= base_url('assets/lib/leaflet.markercluster/leaflet.markercluster.js')?>"></script>
